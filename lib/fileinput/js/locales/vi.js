...
(function ($) {
    ...
    $.fn.fileinputLocales['vi'] = {
        ...
        msgFileRequired: 'Bạn phải chọn một file để upload.',
        ...
        msgTotalFilesTooMany: 'Số lượng tập tin upload <b>({n})</b> vượt quá giới hạn cho phép là <b>{m}</b>.',
        ...
        msgUploadEmpty: 'Không có dữ liệu thỏa mãn để upload.',
        msgUploadError: 'Lỗi Upload',
